...
def test_acquaint_schema_rejects_undleclared_name():
    try:
        fastavro._schema.acquaint_schema({
            "type": "record",
            "fields": [{
                "name": "left",
                "type": "Thinger",
    ...
    except fastavro._schema.UnknownType as e:
...
def test_compose_schemas():
    ...
    schema = fastavro._schema.load_schema(schema_path)
...
def test_missing_schema():
    ...
    with pytest.raises(fastavro._schema.UnknownType):
